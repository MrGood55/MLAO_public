        ...
        if file_path:
            with open(file_path, 'r', encoding='utf-8') as file:
                try:
                    ...
                    if self.start_node_combobox.count() > 0:
    ...
    def seek_shortest_path_gui(self):
        if hasattr(self, 'places_graph'):
            ...
            if start_node and end_node:
                ...
                self.draw_graph()
                # Display the shortest path distance in a pop-up message
                shortest_path_distance = self.places_graph.get_shortest_path_distance()
                QMessageBox.information(self, 'Shortest Path Distance', f"The shortest path distance is: {shortest_path_distance:.2f} meters")
